...
<section id="about" class="py-16">
    <div class="container">
        <div class="image" style="background: url('{{ asset('back1.jpg') }}')">

        </div>
        <div class="info">
            <h2>About Us</h2>
            <p>Welcome to our School ID Lost and Found website. We are dedicated to helping students recover their lost IDs efficiently and promptly. Our platform allows you to report lost IDs, search for found IDs, and get in touch with the rightful owners.</p>
            <p>Our mission is to reduce the stress and inconvenience of losing your school ID by providing a reliable and easy-to-use service for our school community. With a simple and intuitive interface, finding your lost ID has never been easier.</p>
            <p>Thank you for using our service. We hope to make your school life a little bit easier.</p>
        </div>
    </div>

    <div class="container">
        <div class="image">
            <img src="public/background.png" alt="Lost and Found">
        </div>
        <div class="info">
            <h2>How It Works</h2>
            <p>Reporting a lost ID is simple and quick. Just fill out our online form with the necessary details and we will notify you if your ID is found. You can also browse through the list of found IDs to see if yours is listed.</p>
            <p>Once a match is found, our team will coordinate with you to ensure a safe and secure return of your ID. We value your privacy and take all necessary steps to protect your personal information.</p>
            <p>Join our community today and help us create a safer and more connected school environment.</p>
        </div>
    </div>

    <div class="container">
        <div class="image">
            <img src="public/back1.jpg" alt="Lost and Found">
        </div>
        <div class="info">
            <h2>Contact Us</h2>
            <p>If you have any questions or need assistance, our support team is here to help. You can reach us through our contact form, email, or phone. We are committed to providing the best service possible and will respond to your inquiries promptly.</p>
            <p>We also welcome feedback and suggestions to improve our service. Your input is valuable to us and helps us serve you better.</p>
            <p>Thank you for trusting us with your lost and found needs. We look forward to helping you.</p>
        </div>
    </div>
